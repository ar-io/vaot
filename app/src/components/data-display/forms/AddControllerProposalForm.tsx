...
function AddControllerProposalForm({
  ...
  vaotId?: string;
  proposalId?: string;
  proposalParams: (typeof PROPOSAL_TYPE_PARAM_DEFAULTS)['Add-Controller'];
  setProposalParams: (
    params: (typeof PROPOSAL_TYPE_PARAM_DEFAULTS)['Add-Controller'],
  ) => void;
}) {
      ...
      <div className="flex flex-col h-full w-fit">
        ...
        <div className="flex flex-row gap-10 items-center p-2 w-fit">
          <div className="flex flex-col gap-1 min-w-[27rem] ">
            <label className="text-white flex">New Controller</label>
            <input
...
export default AddControllerProposalForm;
