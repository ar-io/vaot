...
function vaot.init()
	...
	addEventingHandler("info", Handlers.utils.hasMatchingTag("Action", "Info"), function(msg)
		Send(msg, {
			Target = msg.From,
			Action = "Info-Notice",
			Data = {
	...
	--[[
		...
		This handler OVERRIDES that and replaces it with our vAOt state initialization handler.
		]]
