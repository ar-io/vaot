...
if (lastMatch && !fileContent.includes("require('.vaot')")) {
  ...
  console.log("Injected require('.vaot') after the last Handlers.append.");
} else if (!lastMatch) {
  console.log('No Handlers.append found in process.lua.');
} else {
  console.log("The require('.vaot') line is already present.");
}
